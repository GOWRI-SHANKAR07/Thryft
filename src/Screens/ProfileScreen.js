...
const ProfileScreen = () => {
  ...
  const { permissionGranted, setPermissionGranted, imageUri, setImageUri } = useAppContext();
  ...
  const requestCameraPermission = async () => {
    try {
      ...
      console.log(PermissionsAndroid.RESULTS.GRANTED, "pre");
    ...
    <View style={styles.container}>
      ...
      <View style={styles.modeCont}>
        <View style={styles.mode}>
          <Text style={{ paddingLeft: pixelSizeHorizontal(10) }}>Seller mode</Text>
